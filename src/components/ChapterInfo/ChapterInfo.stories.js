...
export const ChamkaurChapter1 = () => (
  <ChapterInfo
    ...
    description_english="The Black Sea is a body of water and marginal sea of the Atlantic
            Ocea between the Blakans, Eastern Europe, the Caucasus, and Western
            Asia. It is supplied by a number of majot rivers, such as the
              Danube, Dnieper, Southern Bug, Dniester, Don, and the Rioni."
  />
